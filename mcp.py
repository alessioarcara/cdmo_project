...
def solve_with_mip(file_name, solver, model='three_index_vehicle_flow', timeout_seconds=300):
    ...
    write_json_file(f'{model}_{solver}', obj, solving_time, sol, f'./res/MIP/{instance}.json')
...
if __name__ == "__main__":
    ...
    try:
        ...
        if model_type == "cp":
            ...
            solve_with_mip(file_name, solver_name, timeout_seconds=timeout_seconds)
        else:
